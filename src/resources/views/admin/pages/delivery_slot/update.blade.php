...
@section("content")
				...
				<div class="page-content">
								<div class="container-fluid">
												...
												<!-- start page title -->
												<x-includes.breadcrumb link="delivery_slot.paginate.get" page="Delivery Slot" :list='["Update"]' />
												<!-- end page title -->

												<div class="row" id="image-container">
																<x-includes.back-button link="delivery_slot.paginate.get" />
																<div class="col-lg-12">
																				<form id="countryForm" method="post" action="{{ route("delivery_slot.update.post", $data->id) }}"
																																																...
																																																<div>
																																																				<div class="form-check form-switch form-check-right mb-2">
																																																								<input class="form-check-input" type="checkbox" role="switch"
																																																												id="is_cod_allowed" name="is_cod_allowed"
																																																												{{ $data->is_cod_allowed == false ? "" : "checked" }}>
								...
								validation
												...
												.onSuccess(async (event) => {
																...
																try {
																				...
																				const response = await axios.post('{{ route("delivery_slot.update.post", $data->id) }}', formData)
