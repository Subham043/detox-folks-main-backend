...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list products')
        @include('admin.includes.breadcrumb', ['page'=>'Product Image', 'page_link'=>route('product_image.paginate.get', $product_id), 'list'=>['Update']])
        @endcan
        <!-- end page title -->

        <div class="row" id="image-container">
            @include('admin.includes.back_button', ['link'=>route('product_image.paginate.get', $product_id)])
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('product_image.update.post', [$product_id, $data->id])}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
...
.addField('#image', [
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('product_image.update.post', [$product_id, $data->id])}}', formData)
