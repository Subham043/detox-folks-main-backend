																												...
																												<div id="customerList">
																																<div class="row g-4 mb-3">
																																				<div class="col-sm-auto">
																																								<div>
																																												<a href="{{ route("product_image.create.get", $product_id) }}" type="button"
																																				...
																																				<div class="col-sm">
																																								<x-includes.search :search="$search" :id="$product_id"
																																												link="product_image.paginate.get" />
																																				</div>
																																</div>
																																																				...
																																																				<tr>
																																																								...
																																																								<td>
																																																												<div class="d-flex gap-2">
																																																																<div class="edit">
																																																																				<a href="{{ route("product_image.update.get", [$product_id, $item->id]) }}"
																																																																								class="btn btn-sm btn-primary edit-item-btn">Edit</a>
																																																																</div>

																																																																<div class="remove">
																																																																				<button class="btn btn-sm btn-danger remove-item-btn"
																																																																								data-link="{{ route("product_image.delete.get", [$product_id, $item->id]) }}">Delete</button>
																																																																</div>
																																																												</div>
																																																								</td>
																																																				</tr>
