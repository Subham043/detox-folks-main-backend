...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list products')
        @include('admin.includes.breadcrumb', ['page'=>'Product Image', 'page_link'=>route('product_image.paginate.get', $product_id), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
...
.addField('#image', [
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('product_image.create.post', $product_id)}}', formData)
