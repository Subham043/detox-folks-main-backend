...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list categories')
        @include('admin.includes.breadcrumb', ['page'=>'Sub-Category', 'page_link'=>route('sub_category.paginate.get'), 'list'=>['Update']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row" id="image-container">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('sub_category.update.post', $data->id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
