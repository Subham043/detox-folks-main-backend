...
@section("content")
				...
				<div class="page-content">
								<div class="container-fluid">
												...
												<!-- start page title -->
												<x-includes.breadcrumb link="sub_category.paginate.get" page="Sub-Category" :list='["Create"]' />
												<!-- end page title -->

												<div class="row">
																<x-includes.back-button link="sub_category.paginate.get" />
																<div class="col-lg-12">
																				<form id="countryForm" method="post" action="{{ route("sub_category.create.post") }}"
