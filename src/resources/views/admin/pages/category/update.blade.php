...
@section("content")
				...
				<div class="page-content">
								<div class="container-fluid">
												...
												<!-- start page title -->
												<x-includes.breadcrumb link="category.paginate.get" page="Category" :list='["Update"]' />
												<!-- end page title -->

												<div class="row" id="image-container">
																<x-includes.back-button link="category.paginate.get" />
																<div class="col-lg-12">
																				<form id="countryForm" method="post" action="{{ route("category.update.post", $data->id) }}"
																								enctype="multipart/form-data">
																								@csrf
																								<div class="card">
																												<div class="card-header align-items-center d-flex">
																																<h4 class="card-title flex-grow-1 mb-0">Category Detail</h4>
																												</div><!-- end card header -->
																												<div class="card-body">
																																												...
																																												<div class="mt-md-0 mt-4">
																																																<div>
																																																				<div class="form-check form-switch form-check-right mb-2">
																																																								...
																																																								<label class="form-check-label" for="is_draft">Category
																																																												Publish</label>
																																																				</div>
																																																</div>
																								...
																								<div class="card">
																												<div class="card-header align-items-center d-flex">
																																<h4 class="card-title flex-grow-1 mb-0">Category Seo Detail</h4>
																												</div><!-- end card header -->
																												<div class="card-body">
																																<div class="live-preview">
																																				<div class="row gy-4">
								...
								validation
												...
												.onSuccess(async (event) => {
																...
																try {
																				...
																				const response = await axios.post('{{ route("category.update.post", $data->id) }}', formData)
