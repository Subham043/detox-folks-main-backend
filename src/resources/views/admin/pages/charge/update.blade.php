                        ...
                        <div class="card-body">
                            <div class="live-preview">
                                <div class="row gy-4">
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        @include('admin.includes.input', ['key'=>'exclude_charges_for_cart_price_above', 'label'=>'Exclude Charges For Cart Price Above', 'value'=>$data->exclude_charges_for_cart_price_above])
                                    </div>
