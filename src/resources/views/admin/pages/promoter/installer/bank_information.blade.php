...
@section("content")
				...
				<div class="page-content">
								<div class="container-fluid">
												...
												<!-- start page title -->
												<x-includes.breadcrumb link="promoter.agent.app_installer.get" page="Bank Information" :list='["Update"]' />
												<!-- end page title -->

												<div class="row">
																<x-includes.back-button link="promoter.agent.app_installer.get" />
																<div class="col-lg-12">
																				<form id="countryForm" method="post" action="{{ route("promoter.agent.bank_information.get") }}"
