...
@section("content")
				...
				<div class="page-content">
								<div class="container-fluid">
												...
												<!-- start page title -->
												<x-includes.breadcrumb link="promoter.report.paginate.get" page="Promoter Report Data" :list='["Create"]' />
												<!-- end page title -->

												<div class="row">
																<x-includes.back-button link="promoter.report.paginate.get" />
																<div class="col-lg-12">
																				<form id="countryForm" method="post" action="{{ route("promoter.report.create.post") }}"
																																																...
																																																<div>
																																																				<div class="form-check form-switch form-check-right mb-2">
																																																								<input class="form-check-input" type="checkbox" role="switch"
																																																												id="is_app_installed" name="is_app_installed" checked>
								...
								validation
												...
												.onSuccess(async (event) => {
																...
																try {
																				...
																				const response = await axios.post('{{ route("promoter.report.create.post") }}', formData)
