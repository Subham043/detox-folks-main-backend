...
@section("content")
				...
				<div class="page-content">
								<div class="container-fluid">
												...
												<!-- start page title -->
												<x-includes.breadcrumb link="product.paginate.get" page="Product" :list='["Create"]' />
												<!-- end page title -->

												<div class="row">
																<x-includes.back-button link="product.paginate.get" />
																<div class="col-lg-12">
																				<form id="countryForm" method="post" action="{{ route("product.create.post") }}"
																												...
																												<div class="card-body">
																																<div class="live-preview">
																																				<div class="row gy-4">
																																								...
																																								<div class="col-xxl-12 col-md-12">
																																												<x-includes.quill key="description" label="Description" :value='old("description")' />
																																								</div>
																																								...
																																								<div class="col-lg-3 col-md-6">
																																												<div class="mt-md-0 mt-4">
																																																<div>
																																																				<div class="form-check form-switch form-check-right mb-2">
																																																								<input class="form-check-input" type="checkbox" role="switch"
																																																												id="is_on_sale" name="is_on_sale" checked>
																																								...
																																								<div class="col-lg-3 col-md-6">
																																												<div class="mt-md-0 mt-4">
																																																<div>
																																																				<div class="form-check form-switch form-check-right mb-2">
																																																								<input class="form-check-input" type="checkbox" role="switch"
																																																												id="is_featured" name="is_featured" checked>
																																				...
																																				<div class="row gy-4">
																																								...
																																								<div class="col-xxl-4 col-md-4">
																																												@include("admin.includes.input", [
																																																...
																																																"value" => old("cart_quantity_interval"),
																																												])
																																								</div>
																																								<div class="col-xxl-4 col-md-4">
																																												@include("admin.includes.input", [
																																																...
																																																"value" => old("cart_quantity_specification"),
																																												])
																																								</div>
																...
																$('.repeater-specification').repeater({
																				...
																				ready: function(setIndexes) {
																								validation
																												...
																												.addField('textarea[name="specifications[0][specification_description]"]',
																																[{
																																				rule: 'required',
																																				errorMessage: 'Description is required',
																																}, ])
