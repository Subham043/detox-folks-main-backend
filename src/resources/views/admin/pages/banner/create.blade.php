...
@section("content")
				...
				<div class="page-content">
								<div class="container-fluid">
												...
												<!-- start page title -->
												<x-includes.breadcrumb link="home_page_banner.paginate.get" page="Home Page Banner" :list='["Create"]' />
												<!-- end page title -->

												<div class="row">
																<x-includes.back-button link="home_page_banner.paginate.get" />
																<div class="col-lg-12">
																				<form id="countryForm" method="post" action="{{ route("home_page_banner.create.post") }}"
				...
				<script type="text/javascript" nonce="{{ csp_nonce() }}">
								...
								validation
												...
												.addField('#desktop_image', [{
																				rule: 'required',
																				errorMessage: 'Desktop Image is required',
																},
																{
																				rule: 'minFilesCount',
																				value: 1,
												...
												.onSuccess(async (event) => {
																...
																try {
																				...
																				const response = await axios.post('{{ route("home_page_banner.create.post") }}', formData)
