...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list products')
        @include('admin.includes.breadcrumb', ['page'=>'Product Price', 'page_link'=>route('product_price.paginate.get', $product_id), 'list'=>['Create']])
        @endcan
        <!-- end page title -->
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <form id="countryForm" method="post" action="{{route('product_price.create.post', $product_id)}}" enctype="multipart/form-data">
                @csrf
                    <div class="card">
                            ...
                            <div class="live-preview">
                                <div class="row gy-4">
                                    <div class="col-xxl-4 col-md-4">
                                        @include('admin.includes.input', ['key'=>'min_quantity', 'label'=>'Minimum Quantity', 'value'=>old('min_quantity')])
                                    </div>
                                    <div class="col-xxl-4 col-md-4">
                                        @include('admin.includes.input', ['key'=>'price', 'label'=>'Price', 'value'=>old('price')])
                                    </div>
                                    <div class="col-xxl-4 col-md-4">
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('product_price.create.post', $product_id)}}', formData)
