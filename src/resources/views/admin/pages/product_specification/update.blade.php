...
<div class="page-content">
    <div class="container-fluid">
        ...
        <!-- start page title -->
        @can('list products')
        @include('admin.includes.breadcrumb', ['page'=>'Product Specification', 'page_link'=>route('product_specification.paginate.get', $product_id), 'list'=>['Update']])
        @endcan
        <!-- end page title -->
...
validation
  ...
  .onSuccess(async (event) => {
    ...
    try {
        ...
        const response = await axios.post('{{route('product_specification.update.post', [$product_id, $data->id])}}', formData)
